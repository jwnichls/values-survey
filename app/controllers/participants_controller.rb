class ParticipantsController < ApplicationController
  ...
  def create
    ...
    if @participant.save
      ...
      redirect_to('https://workersandbox.mturk.com/mturk/externalSubmit?condition='+@participant.condition.to_s+'&participant_id='+@participant.id.to_s+'&assignmentId=' + @participant.assignment_id.to_s) 
